...
function initializeFormData(schema, formData) {
  ...
  if (schema && formData && (typeof formData === "undefined" ? "undefined" : _typeof(formData)) === "object" && schema.properties) {
...
function getDefaultOption(defaultOptionLabel) {
  return {
    value: "",
